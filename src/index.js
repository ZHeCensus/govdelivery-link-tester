...
function App() {
  const [url, setUrl] = useState(
    "https://content.govdelivery.com/accounts/USCENSUS/bulletins/251e42f"
  );
  ...
  async function _handleSubmit(e) {
    ...
    const page = await fetch(`https://cors.app.cloud.gov/${url}`).then(res =>
      res.text()
    );
    await setPage(page);
  ...
  return (
    <div className="App">
      ...
      <p>
        Input a https://content.govdelivery.com/accounts/USCENSUS/bulletins/
        link, then click Submit.
      </p>
